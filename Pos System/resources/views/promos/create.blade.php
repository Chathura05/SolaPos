                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('promos.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <x-input-label for="code" value="Promo Code (e.g. SUMMER20)" />
                                <x-text-input id="code" class="block mt-1 w-full uppercase" type="text" name="code" :value="old('code')" required autofocus />
                            ...
                            <div>
                                ...
                                <select id="type" name="type" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                    ...
                                    <option value="fixed" {{ old('type') === 'fixed' ? 'selected' : '' }}>Fixed Amount ({{ setting('currency_symbol', 'Rs.') }})</option>
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="min_spend" class="block mt-1 w-full" type="number" step="0.01" name="min_spend" :value="old('min_spend', 0)" />
                                <x-input-error :messages="$errors->get('min_spend')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="max_uses" value="Maximum Uses (Optional)" />
                                <x-text-input id="max_uses" class="block mt-1 w-full" type="number" name="max_uses" :value="old('max_uses')" placeholder="Leave blank for unlimited" />
                            ...
                            <div class="col-span-1 md:col-span-2">
                                <label for="is_active" class="inline-flex items-center">
                                    <input id="is_active" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }}>
                        ...
                        <div class="flex items-center gap-4 mt-6">
                            <x-primary-button>Create Promo</x-primary-button>
