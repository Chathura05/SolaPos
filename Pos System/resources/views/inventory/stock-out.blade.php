<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">📤 Stock Out</h2>
    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-6">
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-5">Use this form to manually remove stock (damaged goods, write-offs, etc.).</p>

                <form action="{{ route('inventory.stock-out.store') }}" method="POST" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Quantity to Remove <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Reason / Reference</label>
                        <input type="text" name="reference" value="{{ old('reference') }}" placeholder="e.g. Damaged, Expired, Write-off"
                               class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
    ...
    <script>
        ...
        // Removed dynamic stock update since stock varies by showroom and is no longer available on product model
    </script>
</x-app-layout>
