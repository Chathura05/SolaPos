    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('showrooms.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" required
                                   ...
                                   placeholder="e.g. Colombo Branch" value="{{ old('name') }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="location" id="location"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300"
                                   placeholder="123 Main St, City" value="{{ old('location') }}">
                        ...
                        <div class="flex justify-end gap-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                            ...
                            <button type="submit" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition shadow">Save Showroom</button>
                        </div>
                    </form>
                </div>
            </div>
